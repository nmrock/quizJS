(function (global) {
  ...
  var restart = function (currentQuiz) {
    ...
    var newQuiz = new Quiz(quizSelector, paneSelector, answerSelector);
  ...
  /* === CONSTRUCTORS === */
  var Quiz = function (quizSelector, paneSelector, answerSelector) {
    var self = this;
  ...
  Quiz.prototype.buildQuizWrapper = function () {
  ...
  Quiz.prototype.buildResultsPane = function () {
  ...
  Quiz.prototype.buildResultsMessage = function () {
  ...
  Quiz.prototype.buildCounterMessage = function () {
    //
  ...
  Quiz.prototype.createClickHandler = function () {
    var self = this;
      ...
      if (linkElem) {
        if (isExternalRegexClosure(linkElem.href)) {
          ...
          if (linkedUrl.length > 1) {
            ...
            if (confirm('Thank you for visiting ' + siteName + '. You are now leaving the site. We do not exercise control over the content of external websites. Click OK to continue.')) {} else {
              e.preventDefault();
            }
  ...
  Quiz.prototype.setActivePane = function () {
    if (this.activePane) {
  ...
  Quiz.prototype.closeOut = function () {
  ...
  quizPane.prototype.correctElem = {
    ...
    classList: {
      ...
      throwError: function () {
        console.error('Error! Correct answer not set!');
      }
    }
  }
  quizPane.prototype.getMessage = function () {
    ...
    if (message) {
      ...
      newMessage.setAttribute('aria-hidden', 'true');
      return newMessage;
    }
  }

  quizPane.prototype.getButton = function () {
    ...
    if (!button) {
      ...
      this.elem.insertBefore(this.message, button);
    }
  ...
  Quiz.init = function (quizSelector, paneSelector, answerSelector) {
    new Quiz(quizSelector, paneSelector, answerSelector);
  }

  global.Quiz = Quiz.init;

})(window);

new Quiz('.quiz', '.quiz-pane');
